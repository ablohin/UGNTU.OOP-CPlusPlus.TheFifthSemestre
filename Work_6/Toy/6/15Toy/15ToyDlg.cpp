...
void CMy15ToyDlg::OnPaint() 
{
	if (IsIconic())
	{
		...
		gf=dfi*M_PI/180;gf1=-gf;
		double cs=cos(gf), sn=sin(gf),xt,yt,a=100,b=100;
		xt=40*cs-40*sn -a*cs+b*sn+a;  //готовые формулы
		yt=40*sn+40*cs -a*sn-b*cs+b;
		CRect Rectan(xt,yt,xt+60,yt+80); dc.Ellipse(&Rectan);
		double cs1=cos(gf1), sn1=sin(gf1),xt1,yt1,a1=300,b1=120;
		xt1=200*cs1-150*sn1 -a1*cs1+b1*sn1+a1;  //готовые формулы
		yt1=200*sn1+150*cs1 -a1*sn1-b1*cs1+b1;
		CRect Rectan1(xt1,yt1,xt1+60,yt1+80); dc.Ellipse(&Rectan1);
